...
namespace SimpleCRUD.Data.Migrations
{
    ...
    [Migration("20260404223808_RemovingApplicationFromApplicationUserRole")]
    partial class RemovingApplicationFromApplicationUserRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.ApplicationRoles", b =>
                {
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.ApplicationUsers", b =>
                {
                    b.Property<Guid>("ApplicationUserId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ApplicationUserID");
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.Roles", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("RoleID");
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.Users", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UserID");
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.ApplicationUserRole", b =>
                {
                    ...
                    b.HasOne("SimpleCRUD.Data.Entities.ApplicationUsers", "ApplicationUser")
                        .WithMany("ApplicationUserRoles")
            ...
            modelBuilder.Entity("SimpleCRUD.Data.Entities.ApplicationUsers", b =>
                {
                    ...
                    b.HasOne("SimpleCRUD.Data.Entities.Users", "User")
                        .WithMany("ApplicationUsers")
